...
1. click the *view navigation panel* on the top left (see [main UI elements](../getstarted/typo-ui.md#tools-and-plugins)), 
...
1. open the tool menu (:material-apps:) from the top right (see [main UI elements](../getstarted/ui.md#tools-and-plugins)), then 
2. select `Screenshot`.
