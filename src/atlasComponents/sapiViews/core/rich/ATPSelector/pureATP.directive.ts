import { AfterViewInit, Directive, EventEmitter, HostBinding, Input, Output, QueryList, ViewChildren, inject } from "@angular/core";
...
export class PureATPSelectorDirective implements AfterViewInit{
