...
export class MobileOverlay implements OnInit, OnDestroy{
  ...
  @ViewChild('initiator', {static: false, read: ElementRef}) initiator : ElementRef
  @ViewChild('mobileMenuContainer', {static: false, read: ElementRef}) menuContainer : ElementRef
  @ViewChild('intersector', {static: false, read: ElementRef}) intersector: ElementRef
